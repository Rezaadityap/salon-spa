<main id="main" class="main">
    <div class="container-fluid" style="margin-bottom: 100px">
                ...
                <form class="form-inline">
                    ...
                    <div class="form-group mb-2 ml-5">
                        ...
                        <select name="tahun" class="form-control ml-2">
                            ...
                            <?php $tahun = date('Y');
                            // Diambil dari tahun 2020 serta tahun sekarang + 5
                    ...
                    <a href="<?php echo base_url('admin/dataAbsensi/inputAbsensi') ?>"
                        class="btn btn-success mb-2 ml-2"><i class="fas fa-plus"></i> Input Kehadiran</a>
                </form>
            </div>
        </div>
        <?php
        ...
        <div class="alert alert-info">
            Menampilkan Data Absensi Karyawan Bulan : <span class="font-weight-bold">
                <?php echo $bulan ?>
            </span> Tahun :
        ...
        <?php } else { ?>
            <span class="badge badge-danger"><i class="fas fa-info-circle"></i> Data masih kosong, silahkan input data
                kehadiran pada bulan dan tahun yang anda pilih</span>
        <?php } ?>
