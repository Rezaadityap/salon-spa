        ...
        <div class="card-body mt-2">
            ...
            <form method="POST" action="<?php echo base_url('admin/DataTreatment/updateDataAksi')?>">
                <div class="form-group mb-2">
                    ...
                    <input type="hidden" name="id_treatment" class=form-control value="<?php echo $t->id_treatment ?>">
                    <input type="text" name="nama_treatment" class=form-control value="<?php echo $t->nama_treatment ?>">
                ...
                <div class="form-group mb-2">
                    ...
                    <select name="tipe" class=form-control>
                        <option value="<?php echo $t->tipe ?>"><?php echo $t->tipe ?></option>
