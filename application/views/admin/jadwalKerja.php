<main id="main" class="main">
    <div class="container-fluid" style="margin-bottom: 100px">
        ...
        <a class="btn btn-sm btn-success mb-3" href="<?php echo base_url('admin/jadwalKerja/tambahData/') ?>"><i
                class="fas fa-plus"></i> Tambah Data</a>
        <a onclick="return confirm('Yakin ingin menghapus semua data?')" class="btn btn-sm btn-danger mb-3"
            href="<?php echo base_url('admin/jadwalKerja/deleteAll/') ?>"><i class="fas fa-trash"></i> Hapus Semua
            Data</a>
        <?php if (empty($jadwal)) { ?>
                            ...
                            <td>
                                <center>
                                    <a class="btn btn-sm btn-danger tombol-hapus"
                                        href="<?php echo base_url('admin/jadwalKerja/deleteData/' . $j->id_jadwal) ?>"><i
