...
<div class="card mb-3">
        ...
        <form class="form-inline">
            ...
            <?php 
                ...
                <?php if(count($gaji)>0){ ?>
                    <a href="<?php echo base_url('admin/DataGaji/cetakGaji?bulan='.$bulan),'&tahun='.$tahun?>" class="btn btn-success mb-2 ml-2"><i class="fas fa-print"></i> Cetak Daftar Gaji</a>
                <?php }else{ ?>
                    <button type="button" class="btn btn-success mb-2 ml-2" data-toggle="modal" data-target="#myModal"><i class="fas fa-print"></i> Cetak Daftar Gaji</button>
                <?php } ?>
            </form>
        </div>
    </div>     
