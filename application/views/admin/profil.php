        ...
        <div class="panel-body" align="center">
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    ...
                    <a class="btn btn-sm btn-secondary mb-3" href="<?php echo base_url('admin/profil/ubahPassword') ?>"><i
                            class="fas fa-cog"></i> Ubah Password</a>
                </div>
            </div>
        </div>
    <?php endforeach; ?>
