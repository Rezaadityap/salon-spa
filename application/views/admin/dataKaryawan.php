<main id="main" class="main">
    <div class="container-fluid" style="margin-bottom: 100px">
        ...
        <a class="btn btn-sm btn-success mb-3" href="<?php echo base_url('admin/DataKaryawan/tambahData/') ?>"><i
                class="fas fa-plus"></i> Tambah Data Karyawan</a>
                ...
                <td>
                    <center>
                        <a class="btn btn-sm btn-primary"
                            href="<?php echo base_url('admin/dataKaryawan/updateData/' . $k->id_karyawan) ?>"><i
                                class="fas fa-edit"></i></a>
                        <a class="btn btn-sm btn-danger tombol-hapus"
                            href="<?php echo base_url('admin/dataKaryawan/deleteData/' . $k->id_karyawan) ?>"><i
