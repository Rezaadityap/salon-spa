<head>
    ...
    <link href="<?php echo base_url() ?>/assets/member/lib/animate/animate.min.css" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/member/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary navbar-dark sticky-top py-lg-0 px-lg-5 wow fadeIn"
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="<?php echo base_url('login')?>" class="nav-item nav-link">Login<i
