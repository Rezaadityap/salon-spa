...
<div class="limiter">
	<div class="container-login100">
		...
		<div class="flash-data" data-flashdata="<?php echo $this->session->flashdata('pesan'); ?>"></div>					
			...
			<form class="user" method="POST" action="<?php echo base_url('register/lupaPassword') ?>">
                ...
                <hr>
                <button type="submit" class="btn btn-primary btn-user btn-block mb-5">Reset Password</button>
            </form>
